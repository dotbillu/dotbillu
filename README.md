...
[![My Skills](https://skillicons.dev/icons?i=ts,next,react,nodejs,express,mongodb,cpp,solidity,tailwind,docker,threejs,neovim)]()

---

not chasing perfection — just building, learning, and figuring things out one project at a time.  
→ [Portfolio](https://dotbillu.in) | [Dotfiles](https://github.com/dotbillu/dotfiles) 
